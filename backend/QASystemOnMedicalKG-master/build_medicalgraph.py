...
class MedicalGraph:
    def __init__(self):
        ...
        # self.data_path = "G:\\Pycharm_Professional_Projects\\2018_2019_3小学期医疗大数据\\QASystemOnMedicalKG-master\\data\\medical.json"
...
if __name__ == '__main__':
    ...
    # a = handler.read_nodes()
    # print(a)

    # handler.read_nodes()
    # handler.create_node()
    # handler.create_diseases_nodes()
